...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MSResponse<Map<String, List<String>>>> handleNotValidException(
        ...
        MSResponse<Map<String, List<String>>> response = ErrorResponse
    ...
    /**
     * Handles {@link MSException} exceptions.
     *
     *
     * @param e the exception thrown
     * @return a {@link ResponseEntity} with error response
     */
